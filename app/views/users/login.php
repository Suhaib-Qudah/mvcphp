...
<form action="<?php echo URLROOT?>/users/login" method="post">
 ...
 <div class="row mt-4">
 <div class="col"><input class="btn btn-block btn-success" value="Login" type="submit" name="submit"></div>
     <div class="col"><a href="<?php echo URLROOT ;?>/users/register" class="btn btn-block btn-light">No Account? Register</a></div>
 </div>
</div>
